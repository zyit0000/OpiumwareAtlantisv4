Important: No script will execute if a prefix of "OpiumwareScript" isn't added before the script. For example, "OpiumwareScript print('Hello World'"). Also OpiumSetting doesn't work anymore don't use it.
